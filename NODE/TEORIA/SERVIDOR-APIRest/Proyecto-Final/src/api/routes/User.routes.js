...
const { registerWithRedirect, sendCode, resendCode, checkNewUser, login, autoLogin, forgotPassword, sendPassword, changePassword, updateUser, deleteUser } = require("../controllers/User.controllers");
